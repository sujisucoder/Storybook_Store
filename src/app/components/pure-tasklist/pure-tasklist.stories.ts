...
import * as SimpleTaskStory from '../task/task.stories';
...
export const Template: tasklistStyleStory = {
  args: {
    onPinTask: SimpleTaskStory.DefaultTask.args?.onPinTask,
    onArchiveTask: SimpleTaskStory.DefaultTask.args?.onArchiveTask,
  },
};
...
export const Default: tasklistStyleStory = {
  args: {
    tasks: [
      {
        ...(SimpleTaskStory.DefaultTask.args?.['task'] as Task),
        id: '1',
        title: 'Task 1',
      },
      {
